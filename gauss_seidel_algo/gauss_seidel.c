...
double *gauss_seidel_solutions(double **matrix, int lig, int no_of_iterations, double epsilon);
...
int main()
{
	...
	solutions=gauss_seidel_solutions(mat, LIGNES, 20, 0.000001f);
...
double *gauss_seidel_solutions(double **matrix, int lig, int no_of_iterations, double epsilon)
{
	int i=0, j=0, k=0, l=0, iters=0, flag=0;
	double sum=0.0f;
	double delta=0.0f;
	...
	{
		/*
		 * uncomment commented lines below to view iteration process
		*/
